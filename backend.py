...
def auto_generate_user_stories(state:State):
    ...
    llm = llm_func(state["selected_model"])
...
graph_builder.add_node("User Stories", auto_generate_user_stories)
graph_builder.add_node("Human User Story Approval", human_user_story_approval)
graph_builder.add_node("Design Document", create_design_document)
graph_builder.add_node("Human Design Document Review", human_design_document_review)
graph_builder.add_node("Code", generate_code)
...
graph_builder.add_node("Test Cases", write_test_cases)
graph_builder.add_node("Human Test Cases Review", human_test_cases_review)
graph_builder.add_node("QA Review", qa_testing)
...
graph_builder.add_edge("Design Document", "Human Design Document Review")
graph_builder.add_conditional_edges(
    "Human Design Document Review",
    design_document_human_decision,
    {
        "Approve": "Code",
        "Denied": "Design Document"
    }
)
graph_builder.add_edge("Code", "Human Code Review")
graph_builder.add_conditional_edges(
    "Human Code Review",
...
graph_builder.add_edge("Test Cases", "Human Test Cases Review")
graph_builder.add_conditional_edges(
...
graph_builder.add_edge("QA Review", "Human QA Review")
graph_builder.add_conditional_edges(
    "Human QA Review",
